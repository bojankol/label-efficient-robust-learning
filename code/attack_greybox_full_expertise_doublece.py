############################# attack greybox full expertise doublece ##################
###
### Code for the greybox label poisoning attack on the full expertise model
...
#                   annotations_cpu[:,annotator] = label_flip(annotations_cpu[:,annotator], annotation_indices[optimal_point]) # flip label                                                                
            ...
            pickle.dump(test_scores_annotators, open('attack_fullexp_greybox_test_scores_{0}_{1}_{2}_{3}.bin'.format(current_fold, iteration, args.lmd, args.percent_gt), 'wb+'))  # save current results
